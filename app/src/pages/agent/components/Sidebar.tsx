...
function SessionCard({ session, isActive, onClick }: { session: Session; isActive: boolean; onClick: () => void }) {
  return (
    <motion.div
      ...
      onClick={onClick}
      className={`relative mb-1 flex cursor-pointer items-center rounded-xl px-3.5 py-3 transition-all duration-200 ${
        isActive
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center justify-between">
          ...
          <span className="ml-2 flex-shrink-0 text-[11px] font-medium text-gray-400">
